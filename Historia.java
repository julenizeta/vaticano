...
/**
 * 
 * Historia sobre los eventos historicos mas importantes de la Ciudad del Vaticano
...
public class Historia {
	public static void main(String[] args) {
		...
		/**Creamos un array con las diferentes opciones de información histórica**/
		//Creamos un array con las diferentes opciones de información histórica
		String[] opciones = {"Siglo I d.c a 41 d.c", "Años 326-1377", "Años 1870-1878", "Año 1929", "Año 1939-1935", "Despues de 1945", "Hoy en dia"};

		/**Creamos un array con la información correspondiente a cada opción**/
		//Creamos un array con la información correspondiente a cada opción
		String[] sigloI_41 = {"	Durante la República Romana, el nombre \"Vaticano\" se refería al Ager Vaticanus, una zona con una pequeña ",
		...
		String[] A326_1377 = {"	La Basílica Constantina se construyó en el año 326 sobre lo que se creía que era la tumba de San Pedro. ",
		...
		String[] A1870_1878 = {"	En 1870, los diferentes estados de la península italiana se unificaron bajo el poder del Rey Víctor Manuel II. ",
		...
		String[] A1929 = {"	Las negociaciones para la solución de la cuestión Romana comenzaron en 1926 entre el gobierno de Italia y ",
		...
		String[] A1939_1945 = {"	Durante la Segunda Guerra Mundial, la Ciudad del Vaticano, entonces bajo el liderazgo del Papa Pío XII, ",
		...
		String[] A1945 = {"	En 1946, Pío XII, quien no había nombrado cardenales durante la guerra, nombró a 32 de ellos para cubrir los ",
		...
		String[] HOY = {"	Hoy en día, con una diminuta población alrededor de 825 personas, la Ciudad del Vaticano es una monarquía absoluta.",
		...
		/**Pedimos al usuario que seleccione la información que desea ver**/
		//Pedimos al usuario que seleccione la información que desea ver

		Scanner scanner = new Scanner(System.in);

		System.out.println("Bienvenido a la seccion de historia!");
		...
		do
		{
			...
			/**Mostramos la información correspondiente a la opción seleccionada utilizando un switch**/
			//Mostramos la información correspondiente a la opción seleccionada utilizando un switch
			...
			{	
				...
				scanner.nextLine();
				repetir = scanner.nextLine().toLowerCase().charAt(0);
