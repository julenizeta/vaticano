...
public class Quiz {
	...
	public static void main(String[] args) {
		...
		int acertadas = 0;
		int cantidadPreguntas = 5; // Cantidad de preguntas que se hacen al usuario (Se puede cambiar la cantidad de preguntas que se le hace)
		...
		// Inicialización de las preguntas en cada categoría
		preguntasArquitectura = new String[][] 
	 ...
	 /**
     * Permite al usuario escoger una categoría para el cuestionario.
     *
     * @param maximoCategorias El número máximo de categorías disponibles.
     * @return El número de la categoría elegida por el usuario.
     */

	public static int escogerCategoria(int maximoCategorias)
	{
		Scanner sc = new Scanner(System.in);
		int numeroCategoria;
		...
		do 
		{
			...
			if (numeroCategoria < 1 || (numeroCategoria-1) > maximoCategorias)
			{
				System.out.println();
				System.out.println("El numero insertado no esta en el rango permitido!");
	...
	public static int hacerPreguntas(String[][] arrayPreguntas, int numeroPreguntas, ArrayList<String[]> preguntasFalladas)
	{		
		Scanner sc = new Scanner(System.in);
	...
	public static void imprimirFallados(ArrayList<String[]> preguntasFalladas)
	{
	...
	public static String[][] generarPreguntasMixtas(String[][][] arrayPreguntas) {
